...
function plot(data) {
    ...
    myChart(plant1, data.results, data.plot_labels, 'Plant 1');
    ...
    myChart(temp1, data.results, data.plot_labels, 'Temperature 1');
    myChart(temp2, data.results, data.plot_labels, 'Temperature 2');

    myChart(humidity1, data.results, data.plot_labels, 'Humidity 1');
